...
var _leaderboard = require("./scenes/leaderboard");
var _leaderboardDefault = parcelHelpers.interopDefault(_leaderboard);
var _menu = require("./scenes/Menu");
var _menuDefault = parcelHelpers.interopDefault(_menu);
var _score = require("./scenes/Score");
var _scoreDefault = parcelHelpers.interopDefault(_score);
const menuScene = new _menuDefault.default();
const gameScene = new _gameDefault.default();
const scoreScene = new _scoreDefault.default();
const leadeboardScene = new _leaderboardDefault.default();
menuScene.goToGame = ()=>{
    gameScene.init();
};
menuScene.goToLeaderboard = ()=>{
    leadeboardScene.init();
};
gameScene.goToScore = (score)=>{
    scoreScene.init(score);
};
scoreScene.goToLeaderboard = ()=>{
    leadeboardScene.init();
};
leadeboardScene.goToGame = ()=>{
    gameScene.init();
};

},{"./scenes/Menu":"bMuLO","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./scenes/game":"d3vMy","./scenes/Score":"9RBHr","./scenes/leaderboard":"3BkGw"}],"bMuLO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Menu {
    constructor(){
        ...
        this.playButton.addEventListener("click", ()=>{
            this.clean();
            if (this.goToGame) this.goToGame();
        });
...
},{}],"d3vMy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Game {
    ...
    startTimer() {
        ...
        const interval = setInterval(()=>{
            ...
            if (time === 0) {
                ...
                this.goToScore(this.score);
            } else document.getElementById("counter").innerText = time.toString();
        }, 1000);
    }
    getBalls() {
        const balls = _lodashDefault.default.shuffle([
            ...COLORS.map((colour)=>({
                    colour,
                    shape: "square"
                })
    ...
    nextIteration() {
        ...
        const correctBall = _lodashDefault.default.sample(balls);
        const misleadingColour = _lodashDefault.default.sample(COLORS);
        this.clearBalls();
        balls.forEach((ball, index)=>{
            document.getElementById("ball-" + index).classList.add(ball.colour);
            document.getElementById("ball-" + index).classList.add(ball.shape);
            document.getElementById("ball-" + index).onclick = ()=>{
                if (ball.colour === correctBall.colour) {
                    this.score++;
        ...
        document.getElementById("prompt").innerText = correctBall.colour;
        document.getElementById("prompt").className = misleadingColour;
    }
    clearBalls() {
    ...
    clear() {
        // document.getElementById("gui").className = "hidden";
        this.clearBalls();
    }
}
...
},{}],"9RBHr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Score
);
...
class Score {
        ...
        this.submitButton.addEventListener("click", ()=>{
            ...
            _crossFetchDefault.default(`http://dreamlo.com/lb/9eJAhNf4sk-d8wCNvbubnQmjNrogtxR0aAGfXvFxfSAA/add/${playerName}/${score}`).then((response)=>{
                if (response.ok) {
                    ...
                    alert("Something went wrong submitting your score, sorry :(");
    ...
    init(score) {
        this.score = score;
        document.getElementById("gui").className = "";
        document.getElementById("score").className = "scorescreen";
        document.getElementById("counter").className = "hidden";
        document.getElementById("prompt").className = "hidden";
        this.scorescreen.className = "";
    }
    clean() {
        this.scorescreen.className = "hidden";
        document.getElementById("gui").className = "hidden";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","cross-fetch":"aoLqa"}],"aoLqa":[function(require,module,exports) {
...
},{}],"3BkGw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>Leadeboard
);
var _crossFetch = require("cross-fetch");
var _crossFetchDefault = parcelHelpers.interopDefault(_crossFetch);
class Leadeboard {
    constructor(){
        ...
        this.leaderboardElements = document.getElementById("leaderboard-elements");
        this.playButton = document.getElementById("play-button-in-leaderboard");
        this.playButton.addEventListener("click", ()=>{
            this.clean();
            if (this.goToGame) this.goToGame();
        });
    ...
    init() {
        _crossFetchDefault.default("http://dreamlo.com/lb/61a4abb88f418f1278df5a46/json").then((response)=>response.json()
            ...
            entries.slice(0, 4).forEach((element)=>{
                this.leaderboardElements.innerHTML += `
        ...
        this.leaderboard.className = "";
    }
    clean() {
        this.leaderboard.className = "hidden";
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","cross-fetch":"aoLqa"}]},["2HtCd","7PGg5"], "7PGg5", "parcelRequiref11a")
