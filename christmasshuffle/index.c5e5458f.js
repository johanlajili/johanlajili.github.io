...
function playAnimation() {
    if (document.body.classList.contains("pause")) document.body.classList.remove("pause");
    else document.body.classList.add("pause");
}
createStars();
// butoon to pause/play animation
toggleAnimation.addEventListener("click", playAnimation);

//# sourceMappingURL=index.c5e5458f.js.map
